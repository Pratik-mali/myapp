  ...
  return (
    <div className="business-container">
      <section className="hero-section">
        <div className="hero-image">
          <div className="hero-text">
            <h1>बायोडेटा साठी प्रत्येकाची पहिली पसंती....! <br/><span className='brandname'>MAZABIODATA.COM</span></h1>
      ...
      <section className="about-section1">
        ...
        <h1>बायोडाटा <span className='ka'>का</span> महत्त्वाचे?</h1>
          ...
          {filteredTemplates.map((template) => (
            <div key={template.id} className="template-option" onClick={() => handlePreviewClick(template)}>
              ...
              <div className="template-buttons">
                ...
                <button className="template-button" onClick={() => handleCustomizeClick(template)}>वापरा</button>
              </div>
            </div>
          ))}
        </div>
