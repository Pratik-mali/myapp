...
const PreviewPage = () => {
  ...
  useEffect(() => {
    ...
    const loadBackgroundImage = () => {
        ...
        const sections = [
            {keys : ['नाव','जन्मतारीख', 'जन्मवेळ', 'जन्मस्थान', 'जन्मनाव', 'धर्म', 'जात', 'कुलदैवत', 'गोत्र', 'नक्षत्र', 'रास', 'गण', 'नाडी', 'ऊंची', 'रंग', 'रक्तगट','शिक्षण', 'नोकरी', 'पगार'  ]},
            { heading: 'कौटुंबिक माहिती', keys: ['वडिलांचे_नाव', 'वडिलांचा_व्यवसाय', 'आईचे_नाव','बहीण', 'भाऊ', 'मामा', 'चूलते', 'दाजी', 'नातेसंबंध'] },
